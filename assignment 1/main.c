...
int main(void)
{
	...
	//---------------------------------------------------------------------------
	// Create tasks as mentionned in the statement
	TaskHandle_t xHandle_task1 = NULL;
	TaskHandle_t xHandle_task2 = NULL;

	xTaskCreate(vTaskCode1, "Task 1", 1000U, (void *)1, 3U, &xHandle_task1);
	xTaskCreate(vTaskCode2, "Task 2", 500U, (void *)1, 1U, &xHandle_task2);

	// tasks are created now
	//----------------------------------------------------------------------------
